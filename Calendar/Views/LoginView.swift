    ...
    var body: some View {
        NavigationView{
            VStack{
                ...
                CustomHeader(secondTextX: sf.w * 0.5 , secondTextY: sf.h * -0.09, secondTextOpicity: 0.8, secondTextFontSize: sf.w * 0.035,lineLimit: 4).GenerateSecondText()
                    .padding(sf.h * 0.01)
                HStack {
                ...
                HStack {
                        ...
                        Image(self.isPasswordShow ? "eye_close" : "eye_show").frame(height: 10)
                }.modifier(LinearStyle(roundedCornes: 10, startColor: Color("textfield-end"), endColor: Color("button"), textColor: .white))
                    .frame( maxWidth: sf.w * 0.87,maxHeight: sf.h * 0.05)
